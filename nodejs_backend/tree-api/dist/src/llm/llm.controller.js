...
const llm_query_dto_1 = require("./dto/llm-query.dto");
let LlmController = class LlmController {
    llmService;
    constructor(llmService) {
        this.llmService = llmService;
    }
    async getStructuredQuery(dto) {
        return this.llmService.queryTreeFromPrompt(dto.text);
    }
};
exports.LlmController = LlmController;
__decorate([
    (0, common_1.Post)('tree-query'),
    __param(0, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [llm_query_dto_1.LlmQueryDto]),
    __metadata("design:returntype", Promise)
], LlmController.prototype, "getStructuredQuery", null);
